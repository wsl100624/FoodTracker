...
@IBDesignable class RatingControl: UIStackView {
    ...
    private func setupButtons() {
        ...
        for button in ratingButtons {
            removeArrangedSubview(button)   // tell stack view no longer needs to calculate the button
            button.removeFromSuperview()    // remove the button from stack view
        }
